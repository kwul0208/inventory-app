            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" action="<?= base_url('Admin/saveBarangKeluar') ?>" method="post">
                            <label for="nama">Jumblah</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="stok" name='stok' placeholder="Jumblah Barang Keluar">
